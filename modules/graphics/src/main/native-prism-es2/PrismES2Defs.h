...
#if _cph_os_web || _cph_os_rob || _cph_os_appl_emb
    #undef _myfx_gles
    #define _myfx_gles 1
#endif
...
#if !isdef(JLONG_TO_PTR)
    #define JLONG_TO_PTR(value) ((void*)(sw*)(value))
#endif
#if !isdef(PTR_TO_JLONG)
    #define PTR_TO_JLONG(value) ((jlong)(sw*)(value))
#endif
#if !isdef(jlong_to_ptr)
    #define jlong_to_ptr(value) ((void*)(sw*)(value))
#endif
